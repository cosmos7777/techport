...
# test20 Проверка выпадаюдего меню, раздел "Детские товары", Поставщик Chicco, Lego отображаются и кликабельны.
class Test(unittest.TestCase):
    ...
    def test_header_footer(self):
        ...
        # Проверка выпадаюдего меню, раздел "Детские товары", Поставщик Chicco, Lego отображаются и кликабельны.
        driver.find_element_by_class_name("chicco_button").is_displayed()
        driver.find_element_by_class_name("lego_button").is_displayed()
        driver.find_element_by_class_name("chicco_button").is_enabled()
        driver.find_element_by_class_name("lego_button").is_enabled()
